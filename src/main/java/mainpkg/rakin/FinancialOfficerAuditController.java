...
{
    @javafx.fxml.FXML
    private TableView foAuditsTV;
    @javafx.fxml.FXML
    private TableColumn amountCol;
    @javafx.fxml.FXML
    private TableColumn statusCol;
    @javafx.fxml.FXML
    private TableColumn errorIdCol;
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    public void foAuditResolvedButtonOnClick(ActionEvent actionEvent) {
    }
    ...
    @javafx.fxml.FXML
    public void foAuditReviewButtonOnClick(ActionEvent actionEvent) {
    }
