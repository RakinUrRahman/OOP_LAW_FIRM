...
{
    @javafx.fxml.FXML
    private TableColumn caseRefCol;
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    private TableView clientPaymentTable;
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    public void onRefreshClientPayments(ActionEvent actionEvent) {
    }
    ...
    @javafx.fxml.FXML
    public void onExportClientPayments(ActionEvent actionEvent) {
    }
