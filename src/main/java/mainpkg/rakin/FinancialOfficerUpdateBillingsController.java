...
public class FinancialOfficerUpdateBillingsController
{
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    public void onUpdateRateClicked(ActionEvent actionEvent) {
    }
    ...
    @javafx.fxml.FXML
    public void onSaveAllRates(ActionEvent actionEvent) {
    }
