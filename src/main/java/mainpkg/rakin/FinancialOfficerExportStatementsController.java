...
public class FinancialOfficerExportStatementsController
{
    @javafx.fxml.FXML
    private TableColumn statementIdCol;
    @javafx.fxml.FXML
    private TableColumn totalAmountCol;
    @javafx.fxml.FXML
    private TableColumn exportStatusCol;
    @javafx.fxml.FXML
    private TableColumn periodCol;
    @javafx.fxml.FXML
    private TableView financialExportTable;
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    public void foExportStatementsExportButtonOnClick(ActionEvent actionEvent) {
    }
